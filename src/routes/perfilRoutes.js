...
const FLAGS = ['acesso_financeiro','acesso_relatorio_financeiro','acesso_financeiro_global','acesso_financeiro_saida','acesso_escala_global','acesso_cultos','acesso_escalas','acesso_comunicacoes']
...
router.post('/criar', autenticar, apenasAdmin, (req, res) => {
  const { nome, acesso_financeiro, acesso_relatorio_financeiro, acesso_financeiro_global, acesso_financeiro_saida, acesso_escala_global, acesso_cultos, acesso_escalas, acesso_comunicacoes } = req.body
...
router.put('/:id', autenticar, apenasAdmin, (req, res) => {
  ...
  sql.run(
    `UPDATE usuarios SET acesso_financeiro=?,acesso_relatorio_financeiro=?,acesso_financeiro_global=?,acesso_financeiro_saida=?,acesso_escala_global=?,acesso_cultos=?,acesso_escalas=?,acesso_comunicacoes=? WHERE perfil_id=?`,
    p.acesso_financeiro, p.acesso_relatorio_financeiro, p.acesso_financeiro_global, p.acesso_financeiro_saida, p.acesso_escala_global, p.acesso_cultos, p.acesso_escalas, p.acesso_comunicacoes, req.params.id
  )
